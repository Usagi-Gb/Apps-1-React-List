   ...
   <>
     <fieldset>
       ...
       <form >
         ...
         <p>
           <label>Pretos: </label><input name='olhos' type="radio" value={"Pretos"} onChange={handleChange} /> <br />
         ...
         <label>Chapeu</label><input type="checkbox" name='acessorios' value={"Chapeu"} onChange={handleChange} /> <br />
         <label>Colar</label><input type="checkbox" name='acessorios' value={"Colar"} onChange={handleChange} /> <br />
         <label>Arma</label><input type="checkbox" name='acessorios' value={"Arma"} onChange={handleChange} /> <br />
         <label>Aneis</label><input type="checkbox" name='acessorios' value={"Aneis"} onChange={handleChange} /> <br />
       </form>
     </fieldset>
     <fieldset>
