...
function App() {
 ...
 return (
   <>
   {favoritado ? <button style={estilo} onClick={() => Favoritar()}>Favoritar 🌟 ({favoritos})</button> :  <button style={estilo}  onClick={() => DesFavoritar()}>Remover favorito ⭐ ({favoritos})</button> }  
   </>
 )
}
